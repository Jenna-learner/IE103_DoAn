...
('L005', 'Trà trái cây', 'Trà nền trái cây tươi'),
('L006', 'Nước ép & soda', 'Nước ép, soda, sparkling')
...
('NL009', 'Sữa đặc', 'ml', 'Active'),
('NL010', 'Siro vanilla', 'ml', 'Active'),
('NL011', 'Siro hazelnut', 'ml', 'Active'),
('NL012', 'Sốt chocolate', 'ml', 'Active'),
('NL013', 'Trà ô long', 'gram', 'Active'),
('NL014', 'Trà hibiscus', 'gram', 'Active'),
('NL015', 'Đào ngâm', 'gram', 'Active'),
('NL016', 'Vải ngâm', 'gram', 'Active'),
('NL017', 'Xoài puree', 'ml', 'Active'),
('NL018', 'Dâu puree', 'ml', 'Active'),
('NL019', 'Nước soda', 'ml', 'Active'),
('NL020', 'Chanh vàng', 'quả', 'Active'),
('NL021', 'Cam vàng', 'quả', 'Active'),
('NL022', 'Bánh croissant đông lạnh', 'cái', 'Active'),
('NL023', 'Phô mai kem', 'gram', 'Active'),
('NL024', 'Bơ lạt', 'gram', 'Active')
...
('CN001', 'NL009', 4200, 2500, 22),
('CN001', 'NL010', 1800, 1200, 48),
('CN001', 'NL011', 1500, 900, 52),
('CN001', 'NL012', 2100, 1000, 60),
('CN001', 'NL013', 3200, 1800, 170),
('CN001', 'NL014', 1800, 900, 190),
('CN001', 'NL015', 2400, 1200, 88),
('CN001', 'NL016', 2200, 1200, 92),
('CN001', 'NL017', 2600, 1400, 65),
('CN001', 'NL018', 2100, 1200, 68),
('CN001', 'NL019', 5600, 2800, 20),
('CN001', 'NL020', 220, 120, 1800),
('CN001', 'NL021', 260, 120, 2200),
('CN001', 'NL022', 90, 50, 12000),
('CN001', 'NL023', 1500, 800, 240),
('CN001', 'NL024', 1800, 900, 180),
('CN002', 'NL009', 3400, 2500, 22),
('CN002', 'NL010', 1600, 1200, 48),
('CN002', 'NL011', 1400, 900, 52),
('CN002', 'NL012', 1800, 1000, 60),
('CN002', 'NL013', 2800, 1800, 170),
('CN002', 'NL014', 1400, 900, 190),
('CN002', 'NL015', 1800, 1200, 88),
('CN002', 'NL016', 1900, 1200, 92),
('CN002', 'NL017', 2200, 1400, 65),
('CN002', 'NL018', 1700, 1200, 68),
('CN002', 'NL019', 4700, 2800, 20),
('CN002', 'NL020', 190, 120, 1800),
('CN002', 'NL021', 220, 120, 2200),
('CN002', 'NL022', 70, 50, 12000),
('CN002', 'NL023', 1300, 800, 240),
('CN002', 'NL024', 1400, 900, 180),
('CN003', 'NL001', 9800, 8000, 425),
('CN003', 'NL002', 12500, 12000, 29),
('CN003', 'NL004', 5200, 5000, 182),
('CN003', 'NL007', 280, 300, 1250),
('CN003', 'NL008', 4300, 4500, 18),
('CN003', 'NL009', 3000, 2500, 22),
('CN003', 'NL010', 1200, 1200, 48),
('CN003', 'NL013', 2500, 1800, 170),
('CN003', 'NL017', 1900, 1400, 65),
('CN003', 'NL019', 3900, 2800, 20),
('CN003', 'NL022', 60, 50, 12000)
...
('SP007', 'Cappuccino', 'L001', 56000, 'Available'),
('SP008', 'Mocha', 'L001', 59000, 'Available'),
('SP009', 'Bạc xỉu', 'L001', 42000, 'Available'),
('SP010', 'Trà sữa matcha', 'L002', 59000, 'Available'),
('SP011', 'Trà sữa ô long', 'L002', 56000, 'Available'),
('SP012', 'Sữa tươi trân châu đường đen', 'L002', 61000, 'Available'),
('SP013', 'Chocolate đá xay', 'L003', 65000, 'Available'),
('SP014', 'Caramel Frappe', 'L003', 67000, 'Available'),
('SP015', 'Tiramisu', 'L004', 52000, 'Available'),
('SP016', 'Cheesecake việt quất', 'L004', 56000, 'Available'),
('SP017', 'Trà đào cam sả', 'L005', 55000, 'Available'),
('SP018', 'Trà vải hoa hồng', 'L005', 57000, 'Available'),
('SP019', 'Trà dâu hibiscus', 'L005', 56000, 'Available'),
('SP020', 'Trà xoài nhiệt đới', 'L005', 58000, 'Available'),
('SP021', 'Soda chanh bạc hà', 'L006', 49000, 'Available'),
('SP022', 'Soda việt quất', 'L006', 52000, 'Available'),
('SP023', 'Nước ép cam', 'L006', 52000, 'Available'),
('SP024', 'Nước ép dưa hấu', 'L006', 49000, 'Available')
...
DELETE FROM CONGTHUC WHERE MaSP IN (
  'SP001', 'SP002', 'SP003', 'SP004', 'SP005', 'SP006',
  'SP007', 'SP008', 'SP009', 'SP010', 'SP011', 'SP012',
  'SP013', 'SP014', 'SP015', 'SP016', 'SP017', 'SP018',
  'SP019', 'SP020', 'SP021', 'SP022', 'SP023', 'SP024'
);
...
('SP007', 'NL001', 18), ('SP007', 'NL002', 160), ('SP007', 'NL007', 1),
('SP008', 'NL001', 18), ('SP008', 'NL002', 120), ('SP008', 'NL012', 25), ('SP008', 'NL007', 1),
('SP009', 'NL001', 16), ('SP009', 'NL002', 110), ('SP009', 'NL009', 30), ('SP009', 'NL007', 1),
('SP010', 'NL006', 16), ('SP010', 'NL002', 120), ('SP010', 'NL005', 60), ('SP010', 'NL008', 25), ('SP010', 'NL007', 1),
('SP011', 'NL013', 16), ('SP011', 'NL002', 120), ('SP011', 'NL005', 60), ('SP011', 'NL008', 25), ('SP011', 'NL007', 1),
('SP012', 'NL002', 180), ('SP012', 'NL005', 80), ('SP012', 'NL008', 25), ('SP012', 'NL007', 1),
('SP013', 'NL012', 35), ('SP013', 'NL002', 140), ('SP013', 'NL008', 20), ('SP013', 'NL007', 1),
('SP014', 'NL003', 30), ('SP014', 'NL002', 130), ('SP014', 'NL008', 20), ('SP014', 'NL007', 1),
('SP015', 'NL023', 40), ('SP015', 'NL007', 1),
('SP016', 'NL023', 55), ('SP016', 'NL018', 20), ('SP016', 'NL007', 1),
('SP017', 'NL004', 14), ('SP017', 'NL015', 60), ('SP017', 'NL020', 1), ('SP017', 'NL021', 1), ('SP017', 'NL007', 1),
('SP018', 'NL004', 14), ('SP018', 'NL016', 60), ('SP018', 'NL010', 15), ('SP018', 'NL007', 1),
('SP019', 'NL014', 12), ('SP019', 'NL018', 35), ('SP019', 'NL008', 20), ('SP019', 'NL007', 1),
('SP020', 'NL013', 14), ('SP020', 'NL017', 40), ('SP020', 'NL008', 20), ('SP020', 'NL007', 1),
('SP021', 'NL019', 160), ('SP021', 'NL020', 1), ('SP021', 'NL008', 20), ('SP021', 'NL007', 1),
('SP022', 'NL019', 160), ('SP022', 'NL018', 25), ('SP022', 'NL008', 20), ('SP022', 'NL007', 1),
('SP023', 'NL021', 2), ('SP023', 'NL007', 1),
('SP024', 'NL024', 180), ('SP024', 'NL007', 1);
